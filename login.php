 ...
 * - CSRF token dinonaktifkan sementara untuk mengatasi error token tidak valid
 * - Redirect menggunakan PATH RELATIF (bukan BASE_URL) untuk menghindari session expired
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // =============================================================
    // VALIDASI CSRF TOKEN - DINONAKTIFKAN SEMENTARA
    // =============================================================
    // CSRF token validation disabled - comment untuk sementara
    /*
        ...
        try {
            ...
            if ($user) {
                ...
                if (password_verify($password, $user['password_hash'])) {
                    ...
                    // =========================================================
                    // LOGIKA REDIRECT BERDASARKAN USER TYPE - PAKAI PATH RELATIF
                    // =========================================================
                    
                    // Gunakan path relatif, BUKAN BASE_URL
                    switch($user['user_type']) {
                        case 'Admin':
                            $redirect_path = '/responsive-message-app/modules/admin/dashboard.php';
                            break;
                        case 'Kepala_Sekolah':
                        case 'Wakil_Kepala':
                            $redirect_path = '/responsive-message-app/modules/wakepsek/dashboard.php';
                            break;
                        case 'Guru_BK':
                        case 'Guru_Humas':
                        case 'Guru_Kurikulum':
                        case 'Guru_Kesiswaan':
                        case 'Guru_Sarana':
                            $redirect_path = '/responsive-message-app/modules/guru/followup.php';
                            break;
                        case 'Guru':
                            $redirect_path = '/responsive-message-app/modules/user/send_message.php';
                            break;
                        case 'Siswa':
                        case 'Orang_Tua':
                            $redirect_path = '/responsive-message-app/modules/user/send_message.php';
                            break;
                        default:
                            $redirect_path = '/responsive-message-app/index.php';
                    }
                    
                    error_log("FINAL REDIRECT TO: " . $redirect_path . " (User Type: " . $user['user_type'] . ")");
...
if (isset($_SESSION['user_id'])) {
    ...
    if (isset($_GET['error']) && $_GET['error'] == 'session_expired') {
        ...
        // =========================================================
        // LOGIKA REDIRECT UNTUK USER YANG SUDAH LOGIN - PAKAI PATH RELATIF
        // =========================================================
        ...
        error_log("REDIRECT URL: " . $redirect_path . " (User Type: " . $userType . ")");
            ...
            <div class="card border-0 shadow-lg">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="" id="loginForm">
                        <!-- CSRF Token - Tetap dikirim meskipun validasi dimatikan -->
                    ...
                    <div class="alert alert-info mt-3 mb-0">
                        <small>
                            ...
                            - Kepala Sekolah: kepsek / password<br>
                            - Wakil Kepala: wakepsek / password<br>
