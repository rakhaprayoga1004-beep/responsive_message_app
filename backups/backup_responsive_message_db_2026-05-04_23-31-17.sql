...
CREATE TABLE `audit_logs` (
  ...
  CONSTRAINT `audit_logs_chk_1` CHECK (json_valid(`old_value`)),
  CONSTRAINT `audit_logs_chk_2` CHECK (json_valid(`new_value`))
...
CREATE TABLE `backup_orphan_fk_data` (
  `source_table` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id` int DEFAULT NULL,
  `backup_data` text COLLATE utf8mb4_general_ci,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `external_senders` (
  ...
  `identitas` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `unique_hash` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `is_verified` tinyint(1) DEFAULT '0',
  `verification_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
...
CREATE TABLE `fonnte_config` (
  ...
  `account_token` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `device_id` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `api_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT 'https://api.fonnte.com/send',
  `email` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `password` text COLLATE utf8mb4_general_ci,
  `country_code` varchar(5) COLLATE utf8mb4_general_ci DEFAULT '62',
...
CREATE TABLE `mailersend_config` (
  ...
  `domain_id` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `smtp_server` varchar(255) COLLATE utf8mb4_general_ci DEFAULT 'smtp.mailersend.net',
  `smtp_username` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `smtp_password` text COLLATE utf8mb4_general_ci,
  `smtp_port` int DEFAULT '587',
  `smtp_encryption` varchar(50) COLLATE utf8mb4_general_ci DEFAULT 'tls',
  `test_domain` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT '1',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
CREATE TABLE `message_types` (
  `id` int NOT NULL AUTO_INCREMENT,
  `jenis_pesan` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `responder_type` enum('Guru_BK','Guru_Humas','Guru_Kurikulum','Guru_Kesiswaan','Guru_Sarana') COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `response_deadline_hours` int DEFAULT '72',
  `color_code` varchar(7) COLLATE utf8mb4_unicode_ci DEFAULT '#0d6efd',
  `icon_class` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'fas fa-envelope',
  `is_active` tinyint(1) DEFAULT '1',
...
CREATE TABLE `system_settings` (
  ...
  `setting_type` enum('string','integer','boolean','json','array','text') COLLATE utf8mb4_unicode_ci DEFAULT 'string',
...
CREATE TABLE `users` (
  ...
  `user_type` enum('Siswa','Guru','Orang_Tua','Admin','Guru_BK','Guru_Humas','Guru_Kurikulum','Guru_Kesiswaan','Guru_Sarana','Wakil_Kepala','Kepala_Sekolah','External') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'External',
  `nis_nip` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `privilege_level` enum('Full_Access','Limited_Lv1','Limited_Lv2','Limited_Lv3') COLLATE utf8mb4_unicode_ci DEFAULT 'Limited_Lv3',
...
(1, 'admin', '$2y$10$E1NAKHNbOiQz6puFodqji.6LxOZBePwHFTepLEuutdtlkt7Trc8H6', 'admin@smkn12jakarta.sch.id', 'Admin', 'ADM001', 'Administrator Sistem', NULL, NULL, NULL, 'Full_Access', 81234567890, 'default-avatar.png', 1, '2026-05-04 23:31:10', NULL, NULL, NULL, '2026-02-09 12:16:43', '2026-05-04 23:31:10'),
(2, 'guru001', '$2y$10$E1NAKHNbOiQz6puFodqji.6LxOZBePwHFTepLEuutdtlkt7Trc8H6', 'budi.santoso@smkn12jakarta.sch.id', 'Guru', 198301011, 'Budi Santoso', NULL, NULL, 'Matematika', 'Limited_Lv2', 81122334455, 'default-avatar.png', 1, '2026-05-04 23:17:20', NULL, NULL, NULL, '2026-02-09 12:16:43', '2026-05-04 23:17:20'),
...
(8, 'wakepsek', '$2y$10$E1NAKHNbOiQz6puFodqji.6LxOZBePwHFTepLEuutdtlkt7Trc8H6', 'joko.widodo@smkn12jakarta.sch.id', 'Wakil_Kepala', 198301017, 'Joko Widodo', NULL, NULL, 'Wakil Kepala Sekolah', 'Limited_Lv3', 81122334461, 'default-avatar.png', 1, '2026-05-03 23:38:21', NULL, NULL, NULL, '2026-02-09 12:16:43', '2026-05-03 23:38:21'),
(9, 'kepsek', '$2y$10$E1NAKHNbOiQz6puFodqji.6LxOZBePwHFTepLEuutdtlkt7Trc8H6', 'sri.mulyani@smkn12jakarta.sch.id', 'Kepala_Sekolah', 198301018, 'Sri Mulyani', NULL, NULL, 'Kepala Sekolah', 'Full_Access', 81122334462, 'default-avatar.png', 1, '2026-05-04 23:17:35', NULL, NULL, NULL, '2026-02-09 12:16:43', '2026-05-04 23:17:35'),
...
(12, 'siswa001', '$2y$10$E1NAKHNbOiQz6puFodqji.6LxOZBePwHFTepLEuutdtlkt7Trc8H6', 'ahmad.fadil@smkn12jakarta.sch.id', 'Siswa', 20230001, 'Ahmad Fadil', 'X', 'Rekayasa Perangkat Lunak', NULL, 'Limited_Lv3', 81122334401, 'default-avatar.png', 1, '2026-05-04 23:17:07', NULL, NULL, NULL, '2026-02-09 12:16:43', '2026-05-04 23:17:07'),
...
CREATE TABLE `whatsapp_devices` (
  `id` int NOT NULL AUTO_INCREMENT,
  `device_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nama perangkat',
  `device_number` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nomor perangkat (format internasional)',
  `api_token` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Token API untuk perangkat',
  `api_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'https://api.fonnte.com/send' COMMENT 'URL API',
  `status` enum('connected','disconnected','expired','pending') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `last_connected_at` datetime DEFAULT NULL,
  `expired_at` date DEFAULT NULL COMMENT 'Tanggal kadaluarsa paket',
  `total_messages_sent` int NOT NULL DEFAULT '0',
  `total_messages_limit` int DEFAULT '1000' COMMENT 'Batas pesan per bulan',
...
CREATE TABLE `api_tokens` (
  ...
  CONSTRAINT `api_tokens_chk_1` CHECK (json_valid(`permissions`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `backups` (
  ...
  `size_bytes` bigint DEFAULT NULL,
  `backup_type` enum('Full','Incremental','Differential') COLLATE utf8mb4_unicode_ci DEFAULT 'Full',
  `status` enum('Success','Failed','In Progress') COLLATE utf8mb4_unicode_ci DEFAULT 'Success',
  `error_message` text COLLATE utf8mb4_unicode_ci,
  `created_by` int DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `messages` (
  ...
  `external_sender_id` int DEFAULT NULL,
  `pengirim_nama` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pengirim_email` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pengirim_phone` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pengirim_nis_nip` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `isi_pesan` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('Pending','Dibaca','Diproses','Disetujui','Ditolak','Selesai','Expired','Dibatalkan') COLLATE utf8mb4_unicode_ci DEFAULT 'Pending',
  `responder_id` int DEFAULT NULL,
  `is_external` tinyint(1) DEFAULT '0',
  `ip_address` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_agent` text COLLATE utf8mb4_unicode_ci,
  `submission_channel` enum('web','mobile','api') COLLATE utf8mb4_unicode_ci DEFAULT 'web',
  `catatan_respon` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `notifications` (
  ...
  `icon_class` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'fas fa-bell',
...
CREATE TABLE `response_templates` (
  `id` int NOT NULL AUTO_INCREMENT,
  `guru_type` enum('Guru_BK','Guru_Humas','Guru_Kurikulum','Guru_Kesiswaan','Guru_Sarana') COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `content` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `category` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'Umum',
  `default_status` enum('Disetujui','Ditolak','Ditunda','Diproses') COLLATE utf8mb4_unicode_ci DEFAULT 'Diproses',
  `is_active` tinyint(1) DEFAULT '1',
...
CREATE TABLE `sessions` (
  ...
  `csrf_token` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_mobile` tinyint(1) DEFAULT '0',
  `device_info` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  PRIMARY KEY (`session_id`),
  KEY `idx_sessions_user_id` (`user_id`),
  CONSTRAINT `fk_sessions_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `sessions_chk_1` CHECK (json_valid(`device_info`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `message_attachments` (
  ...
  `virus_scan_status` enum('Pending','Clean','Infected','Error') COLLATE utf8mb4_unicode_ci DEFAULT 'Pending',
...
CREATE TABLE `message_deletion_log` (
  ...
  `deleted_by_type` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `delete_reason` text COLLATE utf8mb4_general_ci,
  `message_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `has_response` tinyint(1) DEFAULT '0',
  `original_status` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `message_deletion_log_chk_1` CHECK (json_valid(`message_data`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `message_responses` (
  ...
  `catatan_respon` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('Disetujui','Ditolak','Ditunda','Diproses') COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_external` tinyint(1) DEFAULT '0',
...
CREATE TABLE `whatsapp_logs` (
  ...
  `provider` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'CallMeBot',
  `response_code` int DEFAULT NULL,
...
CREATE TABLE `notification_logs` (
  `id` int NOT NULL AUTO_INCREMENT,
  `message_id` int NOT NULL COMMENT 'ID pesan dari tabel messages',
  `response_id` int DEFAULT NULL COMMENT 'ID respons dari tabel message_responses (jika ada)',
  `notification_type` enum('email','whatsapp','sms','telegram') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'email' COMMENT 'Jenis notifikasi',
  `recipient` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tujuan notifikasi (email atau nomor HP)',
  `status` enum('sent','failed','pending','delivered','read') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT 'Status pengiriman',
  `details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT 'Detail lengkap respons API',
  ...
  CONSTRAINT `notification_logs_chk_1` CHECK (json_valid(`details`))
...
-- =====================================================
-- Database: responsive_message_db
-- Backup Date: 2026-05-04 23:31:18
-- Total Tables: 35
-- Total Views: 5
